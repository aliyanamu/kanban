      ...
      <div class="addBox ui segment">
        <div class="form">
          ...
          <div class="md-form">
            ...
            <input v-model="who" type="text" id="person" class="form-control">
          </div>
          <div class="md-form">
            <label for="point"><i class="fas fa-star"></i>Prority</label>
            <input v-model="point" type="text" id="point" class="form-control">
          </div>
        </div>
